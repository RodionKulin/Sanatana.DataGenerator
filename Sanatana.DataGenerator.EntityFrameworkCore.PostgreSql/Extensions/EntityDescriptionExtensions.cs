...
namespace Sanatana.DataGenerator.Entities
{
    ...
    {
        /// <summary>
        /// Add EfCorePersistentStorage to store entity instances in Postgre SQL.
        ...
        /// <returns></returns>
        public static EntityDescription<TEntity> AddEfCorePersistentStoragePostgreSql<TEntity>(
            this EntityDescription<TEntity> entityDescription, Func<DbContext> dbContextFactory)
            where TEntity : class
        {
            IRepositoryFactory repositoryFactory = new PostgreRepositoryFactory(dbContextFactory);
