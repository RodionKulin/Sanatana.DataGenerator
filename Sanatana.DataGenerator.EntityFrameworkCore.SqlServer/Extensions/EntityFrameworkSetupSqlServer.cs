...
namespace Sanatana.DataGenerator.EntityFrameworkCore.Extensions
{
    ...
    public class EntityFrameworkSetupSqlServer
    {
        //fields
        ...
        //init
        public EntityFrameworkSetupSqlServer(GeneratorSetup generatorSetup, Func<DbContext> dbContextFactory)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual EntityFrameworkSetupSqlServer SetupFullEfSettingsBundle()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual EntityFrameworkSetupSqlServer RegisterEntitiesFromEfDbContext()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual EntityFrameworkSetupSqlServer SetInsertToPersistentStorageBeforeUseForAutoGeneratedPropertiesFromEfDbContext()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual EntityFrameworkSetupSqlServer SetRequiredFromEfDbContext()
        {
        ...
        /// <returns></returns>
        public virtual EntityFrameworkSetupSqlServer AddDefaultEfSetPrimaryKeysModifier(Type[] typesToExcludeValidation = null)
        {
        ...
        /// <param name="typesToExcludeValidation">Entities that won't be validated</param>
        /// <returns></returns>
        public virtual EntityFrameworkSetupSqlServer AddDefaultEfSetForeignKeysModifier(Type[] typesToExcludeValidation = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual EntityFrameworkSetupSqlServer AddDefaultEfPersistentStorage()
        {
            IRepositoryFactory repositoryFactory = new SqlRepositoryFactory(_dbContextFactory);
