...
namespace Sanatana.DataGenerator.Internals.SubsetGeneration
{
    public class SubsetGeneratorSetupSingle : SubsetGeneratorSetup
    {
        ...
        /// <returns></returns>
        public virtual SubsetGeneratorSetupSingle AddInMemoryStorage(EntitiesSelection entitiesSelection, bool removeOtherStorages = false)
        {
        ...
        /// <param name="removeOtherStorages"></param>
        /// <returns></returns>
        public virtual SubsetGeneratorSetupSingle AddInMemoryStorage<TEntity>(bool removeOtherStorages = false)
            where TEntity : class
        {
            var memoryStorage = new InMemoryStorage();
        ...
        /// <returns></returns>
        public virtual SubsetGeneratorSetupSingle AddStorage(EntitiesSelection entitiesSelection, IPersistentStorage storage, bool removeOtherStorages = false)
        {
        ...
        /// <param name="storage"></param>
        /// <returns></returns>
        public virtual SubsetGeneratorSetupSingle AddStorage<TEntity>(IPersistentStorage storage, bool removeOtherStorages = false)
            where TEntity : class
        {
